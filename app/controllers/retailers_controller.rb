class RetailersController < ApplicationController
  ...
  private
    ...
    def retailer_params
      params.require(:retailer).permit(:first_name, :last_name, :phone_number, :cell_number, :tax_id, :business_name, :address1, :address2, :city, :state, :zip, :years_in_business,user_attributes: [ :id, :email, :name, :password, :meta_id, :meta_type ])
    end
end
